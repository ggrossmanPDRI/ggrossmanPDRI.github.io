...
[7] **Planning for Productive Migration (PPM) in Niger** 
...
[6] **Evaluating scalable approaches to reducing sexual violence towards children in Liberia** 
...
[5] **Broadcasting Tolerance in Kenya** 
*With Erik Wibbels (UPenn), Yotam Margalit (UPenn), and Carolina Torreblanca (UPenn)*   
<details>
  <summary>Description</summary>
...
[4] **Disrupted Aid, Displaced Lives: Unraveling the Impact of Refugee Funding Cuts in Uganda** 
...
[3] **Return Migration: Reducing Barriers and Risks for Social Cohesion in South Sudan** 
...
[2] **Credit Access for Responsible Extraction: Providing Incentives to Address Exploitation and Externalities in Sierra Leone’s Artisanal Mining Sector** 
...
[1] **Does the hidden college contribute to a gender gap in academic success?**
