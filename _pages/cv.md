...
- 2024: **Seminars**: Political Economy at Brown Conference (PEB, keynote speaker) World Bank-UNHCR Joint Data Center Annaual Conference in Cote d’Ivoire (keynote speaker); International Meeting on Experimental and Behavioral Social Sciences (IMEBESS) in Latvia (keynote speaker); Columbia University Comparative Politics Seminar; Penn’s School of Arts and Sciences Board of Advisors meeting; Penn’s PWH weekly seminar; Penn’s CIND lab weekly seminar; Penn’s Political Science department IR seminar; Wharton’s Lauder seminar; Penn State University department seminar. **Conferences**: Forced Displacement Working Group (DC); EGAP (DC); NEWEPS (Princeton); WZB's Meeting on the Political Economy of Development (Berlin, Germany).
